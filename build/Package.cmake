...
if(HAKA_VERSION_BUILD STREQUAL "")
	set(CPACK_PACKAGE_FULLNAME "${CPACK_PACKAGE_NAME}")
else()
	string(TOLOWER ${CMAKE_BUILD_TYPE} build)
	set(CPACK_PACKAGE_FULLNAME "${CPACK_PACKAGE_NAME}-${build}-${LUA}")
endif()

if(DISTRIB_PACKAGE STREQUAL "DEB")
	execute_process(COMMAND dpkg --print-architecture OUTPUT_VARIABLE CPACK_PACKAGE_ARCH OUTPUT_STRIP_TRAILING_WHITESPACE)
	set(CPACK_PACKAGE_FILE_NAME "${CPACK_PACKAGE_FULLNAME}_${CPACK_PACKAGE_VERSION}_${CPACK_PACKAGE_ARCH}")
