...
message("Executing TZ=\"Europe/Paris\" LANG=\"C\" LUA_PATH=\"$ENV{LUA_PATH}\" HAKA_PATH=\"$ENV{HAKA_PATH}\" LD_LIBRARY_PATH=\"$ENV{LD_LIBRARY_PATH}\" C_INCLUDE_PATH=\"$ENV{C_INCLUDE_PATH}\" ${EXE} -d --no-pass-through ${EXE_OPTIONS} -o ${DST}.pcap ${CONF} ${SRC}")
