...
set(LUAJIT_DIR ${CMAKE_CURRENT_BINARY_DIR}/luajit/${INSTALL_DIR} PARENT_SCOPE)
set(LUAJIT_INCLUDE_DIR ${CMAKE_CURRENT_BINARY_DIR}/luajit/${INSTALL_DIR}/include/luajit-2.0 PARENT_SCOPE)
set(LUAJIT_LIBRARY_DIR ${CMAKE_CURRENT_BINARY_DIR}/luajit/${INSTALL_DIR}/lib/ PARENT_SCOPE)
set(LUAJIT_LIBRARY ${CMAKE_CURRENT_BINARY_DIR}/luajit/${INSTALL_DIR}/lib/libluajit-5.1.so PARENT_SCOPE)

macro(LUAJIT_INSTALL)
	install(DIRECTORY ${LUAJIT_DIR}/ DESTINATION .)
endmacro(LUAJIT_INSTALL)
