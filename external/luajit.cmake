...
execute_process(COMMAND echo TARGET_CFLAGS="${LUAJIT_CFLAGS}" TARGET_XCFLAGS="${LUAJIT_XCFLAGS}"
...
add_custom_target(luajit
	COMMAND make -C ${CMAKE_CURRENT_BINARY_DIR}/luajit PREFIX=${INSTALL_FULLDIR} BUILDMODE=dynamic
		TARGET_CFLAGS="${LUAJIT_CFLAGS}" TARGET_XCFLAGS="${LUAJIT_XCFLAGS}"
	COMMAND make -C ${CMAKE_CURRENT_BINARY_DIR}/luajit LDCONFIG='/sbin/ldconfig -n' PREFIX=${INSTALL_FULLDIR}
		BUILDMODE=dynamic CCDEBUG="${LUAJIT_CCDEBUG}" COPTS="${LUAJIT_CCOPT}" XCFLAGS="${LUAJIT_CFLAGS}"
