...
execute_process(COMMAND echo CCDEBUG=${LUAJIT_CCDEBUG} XCFLAGS=${LUAJIT_XCFLAGS} PREFIX=${INSTALL_FULLDIR} OUTPUT_FILE ${CMAKE_CURRENT_BINARY_DIR}/luajit/cmake.tmp)
...
add_custom_target(luajit
	COMMAND make -C ${CMAKE_CURRENT_BINARY_DIR}/luajit PREFIX=${INSTALL_FULLDIR} BUILDMODE=dynamic CCDEBUG="${LUAJIT_CCDEBUG}" XCFLAGS="${LUAJIT_CFLAGS}"
	COMMAND make -C ${CMAKE_CURRENT_BINARY_DIR}/luajit LDCONFIG='/sbin/ldconfig -n' PREFIX=${INSTALL_FULLDIR} BUILDMODE=dynamic CCDEBUG="${LUAJIT_CCDEBUG}" XCFLAGS="${LUAJIT_CFLAGS}"
