...
function TestGrammarCompilation:test_new_grammar_create_multiple_parsers()
	...
	-- When
	local grammar = haka.grammar.new("test_new_grammar_create_multiple_parsers", grammar, true)
...
function TestGrammarCompilation:test_apply_on_branch()
	-- Given
	local buf = haka.vbuffer_from("\x42")
	local grammar = haka.grammar.new("test_apply_on_branch", function ()
		my_branch = branch({
